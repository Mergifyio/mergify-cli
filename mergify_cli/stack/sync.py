...
# stack_sync is now served natively by the Rust binary; the rest of
# this module (get_sync_status, smart_rebase, SyncStatus) is kept only
# because stack/push.py still calls smart_rebase directly. When stack
# push itself lands natively, the whole module goes away too.
