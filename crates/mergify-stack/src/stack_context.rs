...
/// `mergify-cli.stack-github-native`, defaulting to `true`.
///
/// Opt-out like `stack-revision-history`: only the literal string
/// `"false"` disables it, so a stray value can't silently turn off
